...
class RecordingDataTestCase(unittest.TestCase):
    def test_from_dict(self):
        ...
        self.assertEqual(recording_data.frames[0].trackers[0].transform.position, Vector3(0, 0, 0))
        self.assertEqual(recording_data.frames[0].trackers[0].transform.rotation, Quaternion(0, 0, 0, 1))
        self.assertEqual(recording_data.frames[0].trackers[0].transform.scale, Vector3(1, 1, 1))
